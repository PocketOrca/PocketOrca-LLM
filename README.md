...
[下载 v1.3.1](../../releases/latest) · [使用手册](docs/USER-GUIDE-zh.md) · [发布说明](docs/RELEASE-NOTES-v1.3.1.md) · [报告问题](../../issues)
...
详细图文步骤见[使用手册](docs/USER-GUIDE-zh.md)。
...
bash scripts/build.sh          # 产物 app-debug.apk
